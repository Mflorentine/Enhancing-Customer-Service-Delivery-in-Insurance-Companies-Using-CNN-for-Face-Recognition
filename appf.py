...
def main():
    st.subheader('Enhancing Customer Service Delivery in Insurance Companies')#using streamlit to write a title
    ...
    # st.title("Customer Service Delivery in Insurance Companies")
    menu2 = ["Create","Read","Delete"] #list of task choices
    menu3 = ["RSSB","SORAS","PRIME insurance"]#list of database choices
                ...
                if save_uploaded_image(uploaded_image):
                    ...
                    # extract the features
                        ...
                        with col2:
                            ...
                            p="p"
                            markdownstreamlit(("No human face detected"),p)
